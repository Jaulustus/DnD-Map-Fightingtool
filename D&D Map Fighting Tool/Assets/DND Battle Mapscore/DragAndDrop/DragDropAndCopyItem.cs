...
public class DragDropAndCopyItem : MonoBehaviour, IBeginDragHandler, IDragHandler, IEndDragHandler
{
    static public DragDropAndCopyItem draggedItem;                                      // Item that is dragged now
    ...
    public delegate void DragEvent(DragDropAndCopyItem item);
